                  ...
                  {section.items.map((item) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          "flex w-full items-center gap-2.5 rounded-md px-2 py-1.5 text-left text-[0.82rem] text-foreground/90 transition-colors hover:bg-white/[0.07] hover:text-foreground",
                        )}
                      >
