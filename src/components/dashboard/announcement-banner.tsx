...
export function AnnouncementBanner() {
  ...
  return (
    <div className="flex flex-none items-center gap-2.5 border-b border-feed-warn/20 bg-feed-warn/[0.08] px-4 py-1.5">
      <Megaphone className="size-3.5 flex-none text-feed-warn" />
